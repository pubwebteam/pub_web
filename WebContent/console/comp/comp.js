function onReady() {
        ...
        dockedItems: [{
            ...
            items: [
            {
    			...
    			handler:function(){
    				 ...
    				 load(sel.get("id"));
    				 win.setTitle("修改【公司:"+sel.get("short_name")+"】");
    				 win.show();
    	        }
    		},{
    			xtype:'button',
    			...
    			handler:function(){
    				 ...
    				 cx.Msg.confirm("确认删除选中的数据吗？",function(){
    					 var sel = grid.getSelection()[0];
    					 cx.Ajax.request('comp/del.do',{id:sel.get("id")},function(){
    						 query();
    					 });
    				 });
	...
	var form = Ext.create('Ext.form.Panel', {
	    ...
	    items: [
	        ...
	        {allowBlank: false,fieldLabel: '公司全称', name: 'name'},
	        {allowBlank: false,fieldLabel: '公司简称', name: 'short_name'},
	    ...
	    buttons: [
	        {
	        	...
	        	handler: function(){
		        	...
		        	cx.Ajax.request('comp/save.do',data,function(){
		        		query();
    		        	win.hide();
					 });
	        	}
